...
public class ModeloPersona extends Persona {
    ...
    public List<Persona> listaPersonasJDialog() {
        try {
    ...
    public boolean crearPersonaSinFoto() { //Grabar la instancia en la BD
    ...
    public boolean modificarPersonaSinFoto() { //modificar la instancia en la BD
    ...
    public boolean modificarPersonaFoto() {
        try {
            ...
            ps.setDate(3, getFechaDeNacimiento());
